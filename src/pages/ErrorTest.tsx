...
export default function ErrorTest() {
    ...
    const [extremeErrorEnabled, setExtremeErrorEnabled] = useState(false);
                ...
                <Card className="border-destructive/50 bg-destructive/5">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-destructive">
                            ...
                            Extreme Error (Requires Unlock)
                        </CardTitle>
                        <CardDescription>
                            This error will cause a stack overflow and may freeze your browser. Enable the toggle below to unlock.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-background/50 rounded-lg border border-destructive/30">
                            <div className="flex items-center gap-3">
                                <ShieldAlert className="h-5 w-5 text-destructive" />
                                <div>
                                    <Label htmlFor="extreme-toggle" className="text-base font-medium cursor-pointer">
                                        Enable Extreme Error
                                    </Label>
                                    <p className="text-sm text-muted-foreground">
                                        This will unlock the dangerous stack overflow test
                                    </p>
                                </div>
                            </div>
                            <Switch 
                                id="extreme-toggle"
                                checked={extremeErrorEnabled}
                                onCheckedChange={setExtremeErrorEnabled}
                            />
                        </div>
                ...
                <Card className="border-border/50 bg-card/50 backdrop-blur mt-8">
                    ...
                    <CardContent>
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            ...
                            <li>• <strong>For the extreme error</strong>, toggle the switch to unlock it first</li>
                        </ul>
                    </CardContent>
                </Card>
            </div>
